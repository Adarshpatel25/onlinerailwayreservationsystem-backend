...
public class OnlineRailwayReservationSystemApplication {
	...
	public static void main(String[] args) {
		...
		train2.setFromStation("Pipariya");
...
//		trainDestination1.setDestination_date("25/02/2023");
		...
		trainDestination2.setDestination_timing("9:30");
...
//		trainDestination4.setDestination_date("25/02/2023");
		...
		trainDestinations.add(trainDestination1);
		trainDestinations.add(trainDestination2);
		trainDestinations.add(trainDestination3);
		trainDestinations.add(trainDestination4);
				
		
		// inserting trainDestination into train
		train1.setTrainDestination(trainDestinations);
		train2.setTrainDestination(trainDestinations);
